<template>
     ...
     <GreyRow >
      ...
      <b-form v-if="withSearch " inline  style="margin: 5px; margin-left: 20px">
       ...
       <b-form-group class="mr-sm-2" id="input-group-plant" label="Zona ataque :" label-for="input-PlantPartsAnatomy" > 
               <b-form-select 
                  style="margin-left: 10px"
                  id="input-PlantPartsAnatomy"
                  name="input-PlantPartsAnatomy"                  
                  v-model="plantSelected"                            
                  aria-describedby="input-PlantPartsAnatomy-live-feedback"
                  >
                  <option :value="null" :selected="!plantSelected ">None</option>
                  <option v-for="plant in PlantPartsAnatomy" :selected="plantSelected == plant "
                      :key="plant.id"
                      :value="plant">
                      {{ plant.name }} 
                  </option>
      ...
      <b-col style="text-align: right; ">
          <b-button v-can="'plague-create'" v-if="auth.mode"   @click="$router.push({name: 'plaguereate'})"  style=" border-color: #4AAD37;background-color: #4AAD37; margin: 5px">Add new Plague</b-button>
