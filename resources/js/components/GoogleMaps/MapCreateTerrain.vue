<template>
    ...
    watch: {
            // newTerrain: {
            //   handler: function(newUserTerrains) {
    
            //       console.log('newTerrain watch');
            //      this.newTerrain=newUserTerrains;
            ...
            // userTerrains: {
            //  handler: function(newUserTerrains) {
            //         console.log('userTerrains watch');
                 ...
                 controlDiv.appendChild(controlUIserver);
                  ...
                  controlUIserver.addEventListener('click', function() {
                      ...
                      if(vm.newTerrain[0] ){
                         ...
                         vm.newTerrain[0].setMap(null);  ///alter
                        vm.newTerrain=null;
                      }
