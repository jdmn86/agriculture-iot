...
<b-col sm="5" style=" padding: 10px" >
    ...
    border: 1px solid #327927; color:black"  v-for="p in plants" :key="p.id">
                                          <!-- <b-col> -->
                                              <b-row align-h="center" style="margin: 0px">
                                                  ...
                                                  <b-col sm="6">
                                                      ...
                                                      <b-row v-if="p.nome_variedade">
                                                          <h4 >{{p.nome_variedade}}</h4>    
                                                      </b-row>
                                                      <b-row v-else>
                                                          <h4 >{{p.plantType}}</h4>    
                                                      </b-row>
  ...
  export default {
    ...
    computed : {
     ...
     async created() {
      ...
      console.log("Created PlantsOfPlague");
    ...
    mounted () {
      console.log("Mounted PlantsOfPlague");
