<template>
    ...
    border: 1px solid #327927; color:black" v-if="crops" v-for="h in crops" :key="h.id">

                                <b-col>
                                    <b-row align-h="center" @click="goTodetailCultivo(h.id_terrain)">
                                      ...
                                      <!-- <b-col sm="3">
                                          <b-row>
                                              <h5 >{{h.terrain.name}}</h5>
                                          </b-row>
                                      </b-col>   -->  
                                      <b-col sm="3">
                                          <b-row>
                                              <h5 >{{h.start_crop_date}}</h5>
                                          </b-row>
                                      </b-col>    
                                      <b-col v-if="h.finish_crop_date" sm="3">
                                          <b-row>
                                              <h5 >{{h.finish_crop_date}}</h5>
                                          </b-row>
                                      </b-col>
...
import  $bus   from '@/app';
  ...
  export default {
    ...
    computed : {
     ...
     async created() {
      console.log("Created PlantCrops");
    ...
    mounted () {
      console.log("Mounted PlantCrops");
