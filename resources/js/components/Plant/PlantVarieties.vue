<template>
    ...
    border: 1px solid #327927; color:black" @click="$router.push({name: 'plantShow',params: {plantId: v.id} })"  v-for="v in varieties" :key="v.id">
                                          <!-- <b-col> -->
                                              <b-row align-h="center" style="margin: 0px">

                                                  <b-col sm="6">
                                                      <b-row>
                                                          <h5 >{{v.nome_variedade}}</h5>
                                                      </b-row>
                                                      <b-row>
                                                          <h4 >{{v.name}}</h4>    
                                                      </b-row>
                                                   ...
                                                   <b-col sm="3">
                                                     <b-button v-if="auth.mode && !isFormAddNewPlant"   @click="open_EditVariedade(v)"  style=" border-color: #4AAD37;background-color: #4AAD37; margin-bottom: 10px">Edit </b-button>
                                                  </b-col>
                                                  <b-col sm="3">
                                                    <b-button v-if="auth.mode && !isFormAddCrop"   @click="createCrop(v)"  style=" border-color: #4AAD37;background-color: #4AAD37; margin-bottom: 10px">Create crop </b-button>
                                                  </b-col>
    ...
    <!-- <b-col v-if="variedades" style="background-color: white; margin-right: 15px">  

                    <b-row style="margin: 15px">
                      <h3 style="color: rgb(74, 173, 55);">Variedades</h3>
                    </b-row>

                    <b-row >
                         <b-col >
                                      
                                  <b-list-group style=" height: 30vh; overflow-y: scroll;"> 
                                        <b-list-group-item button  style="padding: 10px 5px 10px 5px ;
    border: 1px solid #327927; color:black"   v-for="v in variedades" :key="v.id">
                                          <b-col>
                                              <b-row align-h="center">
                                                  ...
                                                  <b-col sm="6">
                                                   ...
                                                   <b-col sm="3">
                                                     <b-button v-if="EDITMODE && !isFormAddNewPlant"   @click="open_EditVariedade(v)"  style=" border-color: #4AAD37;background-color: #4AAD37; margin-bottom: 10px">Edit </b-button>
                                                  </b-col>
                                                  <b-col sm="3">
                                                    <b-button v-if="EDITMODE && !isFormAddCrop"   @click="createCrop(v)"  style=" border-color: #4AAD37;background-color: #4AAD37; margin-bottom: 10px">Create crop </b-button>
                                                  </b-col>
  ...
  export default {
    ...
    computed : {
     ...
     async created() {
      ...
      console.log("Created PlantVarieties");
    ...
    mounted () {
      console.log("Mounted PlantVarieties");
