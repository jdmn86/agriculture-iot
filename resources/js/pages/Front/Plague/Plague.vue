  ...
  export default {
    ...
    async fetch () {
        ...
        try {
            ...
            await PlantType.api().get('plantType');
            ...
            await PlaguePlantsPartsAnatomy.api().get('plaguePlantsPartsAnatomy');
            await PlantPartsAnatomy.api().get('PlantPartsAnatomy');
    ...
    mounted () {
      console.log("Mounted Plague.vue");
      }
  };
  </script>
