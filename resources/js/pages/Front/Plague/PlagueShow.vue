 ...
 <!-- <b-col style=" color: black; padding: 0px"  > -->
  ...
  <!--   <transition  v-if="!loading " name="slide-fade">
            <router-view :plantReceive="plant" ></router-view>
                ...
                <PlagueDetails :plague="plague" >

                    <template v-can="'plague-delete'" slot="delete" v-if="auth.mode">

                        <ModalToDelete  v-can="'plague-delete'"   >
                ...
                <PartsOfPlague :parts="plague.parts"/>

                <PlantsOfPlague :plants="plague.plants"/>
<!-- if variety -->
...
import PlagueDetails from "@/components/Plague/PlagueDetails";
...
import PartsOfPlague from "@/components/Plague/PartsOfPlague";
import PlantsOfPlague from "@/components/Plague/PlantsOfPlague";
  ...
  export default {
    ...
    computed : {
           ...
           farms(){
            ...
            plague(){
                return Plague.query().with('parts').with('plagueType').with('plants').find(this.plagueId) 
     ...
     async created() {
      ...
      console.log("Created PlagueShow");
    ...
    methods: {
        ...
        async onConfirmDelete(){
          ...
          console.log("on confirm PlagueShow");
          try {
            this.loading = true;
                Farm.api().delete('plague/'+this.plagueId,{delete: this.plagueId});
    ...
    mounted () {
      console.log("Mounted PlagueShow");
