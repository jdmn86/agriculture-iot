...
class CreateAnalyseSoilGuidelinesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('analyse_soil_guidelines', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('analyse_soil_guidelines');
    }
}
